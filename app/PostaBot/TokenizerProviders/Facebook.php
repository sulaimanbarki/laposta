...
class Facebook implements Tokenizable
{
    ...
    {
        return redirect()->to("https:/z/www.facebook.com/v8.0/dialog/oauth?client_id={$this->client_id}&redirect_uri={$this->redirect_uri}&scope=pages_manage_posts,pages_read_engagement,publish_to_groups&response_type=code");
    }
